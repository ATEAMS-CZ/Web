      ...
      <ModalContent backgroundColor={'gray.800'}>
        ...
        <ModalBody>
          <Flex gap={8} flexDirection={'column'}>
            ...
            <Paragraph title={'* Denní průměr okolo 40 hráčů'} text={'40 hráčů pravidelně je hranice, která už není jednoduchá získat pouhým pozváním lidí ze svého streamu, většinou poukazuje na kvalitu serveru.'} />
            <Paragraph title={'* Sociální sítě (př.: Instagram, Twitter, Facebook)'} text={'Server je aktivní na některé sociální síti. Sdílí pravidelně příspěvky a jejich prostřednictvím ohlašuje a sděluje nové informace nebo kterékoliv jiné serverové záležitosti'} />
            <Paragraph title={'* Webové stránky'} text={'Webové stránky serveru mohou obsahovat záznamy o změnách, novinky, nebo například samostatné fórum a seznam členů admin-týmu'} />
          </Flex>
        </ModalBody>
        <ModalFooter flexDirection={'column'} gap={4}>
          <Text fontSize={'12px'}>
            Odstavce označené jako * nejsou povinné, avšak při rozhodování o přijetí serveru dodávají plusové body
          </Text>
